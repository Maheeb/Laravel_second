                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('card.index')}}">All Cards</a>
                            </li>

                            <li>
                                <a href="{{route('card.create')}} ">Create Cards</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('prod.index')}}">All Products</a>
                            </li>

                            <li>
                                <a href="{{route('prod.create')}}">Create Products</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('photo.index')}}">All Photos</a>
                            </li>

                            <li>
                                <a href="{{route('photo.create')}}">Create Photos</a>
                            </li>
